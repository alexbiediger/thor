...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { color: @environment.color, description: @environment.description, name: @environment.name, url: @environment.url }
    end
  ...
  test "should update environment" do
    patch :update, id: @environment, environment: { color: @environment.color, description: @environment.description, name: @environment.name, url: @environment.url }
    assert_redirected_to environment_path(assigns(:environment))
  end
